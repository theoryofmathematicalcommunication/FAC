...
If $U$ is open on $X$, $s(U)$ is open in $\mathcal F$, and, $U$ runs over a base of the topology of $X$, then $s(U)$ is runs over a base of the topology of $\mathcal F$; this is only another way of stating axiom (I)\dots
